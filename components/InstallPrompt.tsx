...
const InstallPrompt: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-[calc(6rem+var(--sab))] left-4 right-4 z-50 animate-in slide-in-from-bottom duration-500 lg:bottom-4 lg:left-auto lg:right-4 lg:w-96">
